...
private struct StrataIcon: View {
    var body: some View {
...
private struct ShimmerMask: ViewModifier {
    ...
    /// Dim level: how visible the non-highlighted text is (0.15 = 15%)
            ...
            TimelineView(.animation) { timeline in
                ...
                content
                    .mask(
                        LinearGradient(
                            stops: [
                                .init(color: dim, location: 0.0),
                                .init(color: dim, location: p1),
                                .init(color: bright, location: p2),
                                .init(color: dim, location: p3),
                                .init(color: dim, location: 1.0),
                            ],
                            startPoint: .leading,
                            endPoint: .trailing
                        )
