...
| **Pro** | $4.99/mo or $39.99/yr | Everything in Free + Kanban, recurring tasks, custom fields, Inline Enhance, AI attachments |
...
- **Inline Enhance**: Accessibility API for system-wide text capture (requires unsandboxed build)
...
| `feature/inline-enhance-system-wide` | ❌ Disabled | ✅ Available | Developer ID |
